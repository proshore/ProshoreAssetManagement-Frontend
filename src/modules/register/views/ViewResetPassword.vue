<script>
    ...
    import {updateUser} from '@/modules/register/services'
    ...
    export default {
      ...
      methods: {
        ...
        async handleSubmit() {
          ...
          if (this.password.value != this.cpassword.value) {
            this.validateField("cpassword");
            this.submission.message ="Passwords should match"
            return;
          }
          if (!this.password.error && !this.cpassword.error) {
            try {
              ...
              this.submission = {message:"Password Reset Successfull", isVerified:true}
          ...
          >
            <div class="register-form-container">
              <div class="register-head">
                <h3 class="register-head-title">Reset Password</h3>
