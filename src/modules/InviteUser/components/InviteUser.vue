    ...
    <div class="modal-content">
        ...
        <div class="title">
            <div class="title-left">
                <div class="header-frame">
                    <img src="../../../assets/plus-stroke.png" alt="" class="plus-stroke">
                    <div class="invite-new-member">Invite new member</div>
                </div>
                <p class="add-a-new-member-to-proshore">Add a new member to proshore</p>
            </div>
            <div class="close-button">
                
                <button class="close-rectangle" type="button" data-cy="close-invite-btn" data-bs-dismiss="modal"><img src="../../../assets/x-lg.png" alt="" class="x-lg"/></button>
        ...
        <!-- <form @submit.prevent="handleSubmit"> -->
            ...
            <div class="input-with-label">
                ...
                <input type="text" placeholder="Username" class="input-text" v-model="name.value" @keyup="validateField('name')" />
                <div v-if="name.error" class="form-text text-danger" v-text="name.error"></div>
            </div>
            <div class="input-with-label">
                <div class="label">Email</div>
                <input type="email" placeholder="ex: myworkmail@gmail.com" class="input-text" v-model="email.value" @keyup="validateField('email')"/>
